...
public class SeleniumElementFinder {
    ...
    public static final class Builder {
        ...
        public Builder byId(FieldName fieldName, String id) {
            ...
            builder.providers.put(fieldName, driver -> driver.findElement(By.id(id)));
            return builder;
        }
        ...
        public Builder byLinkText(FieldName fieldName, String linkText) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.linkText(linkText)));
            return builder;
        }
        ...
        public Builder byPartialLinkText(FieldName fieldName, String partialLinkText) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.partialLinkText(partialLinkText)));
            return builder;
        }
        ...
        public Builder byName(FieldName fieldName, String name) {
            ...
            Objects.requireNonNull(fieldName);
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.name(name)));
            return builder;
        }
        ...
        public Builder byTagName(FieldName fieldName, String tagName) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.tagName(tagName)));
            return builder;
        }
        ...
        public Builder byXPath(FieldName fieldName, String xPath) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.xpath(xPath)));
            return builder;
        }
        ...
        public Builder byClassName(FieldName fieldName, String className) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.className(className)));
            return builder;
        }
        ...
        public Builder byCssSelector(FieldName fieldName, String cssSelector) {
            ...
            final Builder builder = new Builder(webDriver, providers);
            builder.providers.put(fieldName, driver -> driver.findElement(By.cssSelector(cssSelector)));
            return builder;
        }
