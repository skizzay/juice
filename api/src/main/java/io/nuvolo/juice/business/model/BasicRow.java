...
public class BasicRow<T extends Table.Cell> extends AbstractList<T> implements Table.Row<T> {
    ...
    public boolean equals(Object o) {
        ...
        return getRow() == basicRow.getRow() && Objects.equals(table, basicRow.table) && Objects.equals(cellType, basicRow.cellType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), getRow(), table, cellType);
    }
}
