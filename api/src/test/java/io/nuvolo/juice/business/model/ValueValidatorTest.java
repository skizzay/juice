...
class ValueValidatorTest {
    ...
    private void testBlank(String input) {
        // Arrange
        final ValueValidator target = ValueValidator.notBlank();

        // Act
        final var exception = assertThrows(IllegalArgumentException.class, () -> target.validate(input));
    ...
    void equals_givenEqualStrings_doesNotThrow() {
        // Arrange
        final ValueValidator target = ValueValidator.equalTo("abc");
    ...
    void equalsIgnoreCase_givenEqualStrings_doesNotThrow() {
        // Arrange
        final ValueValidator target = ValueValidator.equalToIgnoreCase("abc");
    ...
    void notEquals_givenNonEqualStrings_doesNotThrow() {
        // Arrange
        final ValueValidator target = ValueValidator.notEqualTo("abc");
    ...
    void notEqualsIgnoreCase_givenNonEqualStrings_doesNotThrow() {
        // Arrange
        final ValueValidator target = ValueValidator.notEqualToIgnoreCase("abc");
