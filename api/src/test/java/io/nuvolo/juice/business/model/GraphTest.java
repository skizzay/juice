...
class GraphTest {
    ...
    @Test
    void getNeighbors_whenEmptyGraph_thenEmptyList() {
        // Given
        final Graph<Node> graph = createGraph();

        // When
        final Collection<Node> neighbors = graph.getNeighbors(new Node("A"));
    ...
    @Test
    void getNeighbors_whenSingleNode_thenListIsNotEmpty() {
        // Given
    ...
    @Test
    void getNeighbors_whenSingleEdge_thenTargetNode() {
        // Given
        ...
        // Then
        assertEquals(Set.of(new Node("B")), neighbors);
    }

    @Test
    void getNeighbors_whenMultipleEdges_thenTargetNodes() {
        // Given
        edges.add(new Graph.Edge<>(new Node("A"), new Node("B")));
        ...
        // Then
        assertEquals(Set.of(new Node("B"), new Node("C")), neighbors);
    }

    @Test
    void getShortestPath_whenEmptyGraph_thenEmptyList() {
        // Given
        final Graph<Node> graph = createGraph();
    ...
    @Test
    void getShortestPath_whenSingleNode_thenEmptyList() {
        // Given
        edges.add(new Graph.Edge<>(new Node("A"), new Node("A")));
        final Graph<Node> graph = createGraph();
    ...
    @Test
    void getShortestPath_whenSingleEdge_thenTargetNode() {
        // Given
        edges.add(new Graph.Edge<>(new Node("A"), new Node("B")));
        final Graph<Node> graph = createGraph();
    ...
    @Test
    void getShortestPath_noPathAvailable_thenEmptyList() {
        // Given
        edges.add(new Graph.Edge<>(new Node("A"), new Node("B")));
        final Graph<Node> graph = createGraph();
    ...
    @Test
    void getShortestPath_withMultiplePathsAvailable_thenPathWithLeastNodesIsReturned() {
        // Given
        edges.add(new Graph.Edge<>(new Node("A"), new Node("B")));
